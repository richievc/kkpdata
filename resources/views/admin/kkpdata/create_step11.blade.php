...
@section('content')
    ...
    <form action="{{url('admin/kkpdata/process_step11/' . $account['id'])}}" method="post" enctype="multipart/form-data" class="form-horizontal">
        {!! csrf_field() !!}
           ...
           <h4>Pre-Employment Screening and HR Practices</h4>
            ...
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <a href="{{ url(config('backpack.base.route_prefix', 'admin')) }}/kkpdata/step10/{{$account['id']}}" id="previous" name="previous" class="btn btn-default pull-right">Previous</a>
                </div>
            </div>
