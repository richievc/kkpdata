...
@section('content')
    ...
    <form action="{{url('kkpdata/process_step2/' . $account['id'])}}" method="post" class="form-horizontal">
        {!! csrf_field() !!}
        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <a href="{{url('kkpdata/edit/' . $account['id'])}}" id="previous" name="previous" class="btn btn-default pull-right">Previous</a>
                </div>
            </div>
