...
@section('content')
    ...
    <form action="{{url(Request::segment(1) . '/kkpdata/process_step4/' . $account['id'])}}" method="post" class="form-horizontal">
        {!! csrf_field() !!}
        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <a href="{{url(Request::segment(1) . '/kkpdata/step3/' . $account['id'])}}" id="previous" name="previous" class="btn btn-default pull-right">Previous</a>
                </div>
            </div>
