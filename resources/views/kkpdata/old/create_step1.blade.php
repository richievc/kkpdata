            ...
            <div class="col-md-8">
                ...
                <form action="{{url('kkpdata/process_' . (!empty($account['id']) ? 'edit_' : '') . 'step1/' . (!empty($account['id']) ? $account['id'] : ''))}}" method="post" class="form-horizontal">
                    ...
                    <fieldset>
                        ...
                        <!-- Text input-->
                        <div class="form-group">
                            <div class="col-md-4"><label class="col-md-4 control-label" for="rental_fee_range">Rental Fee Range ($ per month): </label>

                                <input id="rental_fee_range_start" name="rental_fee_range_start"  value="{{@$account['rental_fee_range_start']}}" type="text"  class="form-control col-md-6">
                                <input id="rental_fee_range_end" name="rental_fee_range_end"  value="{{@$account['rental_fee_range_end']}}" type="text"  class="form-control col-md-6">
                            </div>
                        </div>
