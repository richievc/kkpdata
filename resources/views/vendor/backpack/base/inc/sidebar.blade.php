@if (Auth::check())
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          ...
          <div class="pull-left info">
            ...
            <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
          	<a href="{{ url(config('backpack.base.route_prefix', 'admin').'/profile') }}">
        ...
        <!-- Admin Center ============================ -->
          <li class="treeview">
            <a href="#"><i class="fa fa-user-plus"></i> <span>Admin Center</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              ...
              <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/log') }}"><i class="fa fa-file"></i> <span>Logs</span></a></li>
              <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/setting') }}"><i class="fa fa-cog"></i> <span>Settings</span></a></li>
              <li><a href="{{ url('admin/taxonomy') }}"><i class="fa fa-list"></i> <span>Taxonomy</span></a></li>
            </ul>
          </li>
          ...
          <!-- ======================================= -->
          <li class="treeview">
            <a href="#"><i class="fa fa-group"></i> <span>Users Accounts</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
          ...
          <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/kkpdata') }}">
              <i class="fa fa-dashboard"></i> <span>KKPDATA</span>
            </a></li>
        </ul>
      </section>
      <!-- /.sidebar -->
